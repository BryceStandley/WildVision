...
/**
 * Functional React component to display detailed information about a specific animal.
 * The component fetches animal data based on the animal ID from the URL and provides
 * details such as name, type, and date of birth. If available, a video related to the
 * animal is displayed.
 *
 * @component
 */
